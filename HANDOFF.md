...
2. **仓位状态机** (结论随评分口径演进, 以最新口径为准): `quality_kdj5` 口径下重做 A/B —— 开 +115.3%/-13.1%/夏普1.45 **四维全优于** 关 +53.6%/-37.3%/0.62 (数字与主表格同源: refresh_docs.compute_kpis, 夏普√244), 状态机从"核心风控"升级为"收益放大器" (机制见第 8 条: Z0 清仓/降仓释放 slot, 让更高评分新信号进场, slot 周转本身正贡献)。历史口径仅供追溯: 纯动量+ST修复后 开+50.9%/回撤-45.9% vs 关+43.7%/回撤-78.3%; 纯动量+ST修复前 开+32.2% vs 关-78.4% (状态机是唯一风控)。
